<div class="flex flex-col items-center h-auto pb-6 pt-6">
    <x-slot name="header">Tecnicomecanicas</x-slot>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <div class="flex items-center">
                      <div class="ml-4">
                        ...
                        <div class="text-sm text-gray-500">
                            {{$tecnicomecanica->empleado->telefono}}
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td class="flex flex-row gap-2 px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    {{-- Edit --}}
                    <button class="text-indigo-600 hover:text-indigo-900" wire:click="updateModal({{$tecnicomecanica->id}})">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                    </button>
                    {{-- show --}}
                    <button class="text-indigo-600 hover:text-indigo-900" wire:click="show({{$tecnicomecanica->id}})">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    @if($update)
        @include('livewire.tecnicomecanica.update-tecnicomecanica');
    @endif
</div>
