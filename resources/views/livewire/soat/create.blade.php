<div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-3">
	<x-slot name="header">Creacion soats</x-slot>
      ...
      <div class="max-w-md mx-auto">
        <div class="flex items-center space-x-5">
          ...
          <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
            <h2 class="leading-relaxed">Creacion soat</h2>
        ...
        <div class="divide-y divide-gray-200">
          <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
            ...
            <div class="flex flex-col">
              <label class="leading-loose">Poliza</label>
              <input wire:model="soat.poliza" type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="EJ: 1420001202425">
              @error('soat.poliza')<span>{{$message}}</span>@enderror
            </div>
            <div class="flex flex-col">
              <label class="leading-loose">Codigo aseguradora</label>
              <input wire:model="soat.codigo_aseguradora" type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Ej: AT8945">
              @error('soat.codigo_aseguradora')<span>{{$message}}</span>@enderror
            </div>
            <div class="flex flex-col">
              <label class="leading-loose">Clave productor</label>
              <input wire:model="soat.clave_producto" type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Ej: 14257858">
            ...
            <div class="flex items-center space-x-4">
              <div class="flex flex-col">
                ...
                <div class="relative focus-within:text-gray-600 text-gray-400">
                  <input wire:model="soat.fecha_expedicion" type="date" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                </div>
              ...
              <div class="flex flex-col">
                ...
                <div class="relative focus-within:text-gray-600 text-gray-400">
                  <input wire:model="soat.fecha_vencimiento" type="date" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                </div>
